            ...
            <div class="container relative mx-auto">
                <div class="items-center flex flex-wrap">
                    <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                        <div class="pr-12">
                            <form method="POST" action="{{route('job.scrape')}}">
                                @method('POST')
                                @csrf
                                <h1 class="text-white font-semibold text-5xl">
                                    Start your car journey on <a class="text-blue-400" rel="noreferrer"
                                                                 href="http://www.autotrader.co.uk">Autotrader</a>, then
                                    here.
                                </h1>
                                ...
                                @if($errors->has('url'))
                                    <h2 class="text-white font-bold text-xl mt-5 mb-5 border-red-500 border-2 p-5">
                                        {{implode(', ', $errors->get('url'))}}
                                    </h2>
                                @endif
                    ...
                    <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
                        <div class="md:pr-12">
                            ...
                            <p class="mt-4 text-lg leading-relaxed text-gray-600">
                                Inspired by a post on <a class="text-blue-400" target="_blank"
                                                         href="http://reddit.com/r/carTalkUK">/r/carTalkUK</a>,
                                this tool attempts to give you a little insight into how some cars compare on
                                autotrader, without having
                                to use spreadsheets.
                            </p>
                        ...
                        ><i class="fab fa-html5"></i
                            ></span>
                                        ...
                                        <div>
                                            <h4 class="text-gray-600">Wait for the tool to find all the cars with that
                                                search - this can take a few mins!</h4>
                                        </div>
                                    </div>
                                </li>
                                <li class="py-2">
                        ...
                        ><i class="far fa-paper-plane"></i
                            ></span>
                                        ...
                                        <div>
                                            <h4 class="text-gray-600">View the results and organise/download them as you
                                                wish!</h4>
                                        </div>
                                    </div>
                                </li>
